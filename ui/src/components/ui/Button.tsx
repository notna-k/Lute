...
const VARIANTS: Record<ButtonVariant, string> = {
  primary:
    'border border-primary bg-primary text-fg-onPrimary hover:opacity-[0.88]',
  secondary:
  ...
  danger:
    'border border-border bg-surface text-danger hover:border-danger hover:bg-surface-hover',
...
export const LinkButton = forwardRef<HTMLAnchorElement, LinkButtonProps>(
  function LinkButton(
    { variant = 'secondary', size = 'md', leftIcon, rightIcon, fullWidth, className, children, ...rest },
    ref
  ) {
    return (
      <Link
